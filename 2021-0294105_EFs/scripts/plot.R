...
datw$app.mthd.nm <- factor(datw$app.mthd, 
                            levels = c('bsth','os', 'cs'), 
                            labels = c('Trailing hose', 'Open slot injection', 'Closed slot injection')
                           )
datw$incorp.nm <- factor(datw$incorp, levels = c('none', 'shallow', 'deep'), labels = c('None', 'Shallow', 'Deep'))
...
datw$man.source.nm <- factor(datw$man.source, levels = c('cattle', 'pig', 'mix'), labels = c('Cattle', 'Pig', 'Digestate'))
