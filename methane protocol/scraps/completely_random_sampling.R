...
# variable number of measuring periods simulation
output <- data.frame()


for(meas_periods in c(1:14)){
...
write.csv(output, '../output/rand_n_periods.csv', row.names = F)
